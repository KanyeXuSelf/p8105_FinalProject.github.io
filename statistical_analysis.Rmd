...
## We consolidate earnings data across four years (2018, 2019, 2020, and 2021) by performing an iterative inner join on the Countries column. 
   Each year’s data is first filtered, renamed for clarity (Earnings_<Year>), and included in the merge process. 
   The resulting dataset aligns earnings for the same countries across all years, ensuring only countries present in all four years are included. This cleaned and structured data enables paired comparisons and year-over-year analysis.
