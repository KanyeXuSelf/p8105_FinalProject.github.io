...
## The resulting dataset aligns earnings for the same countries across all years, ensuring only countries present in all four years are included. 
## This cleaned and structured data enables paired comparisons and year-over-year analysis.
```{r}
paired_data <- reduce(
  list(
